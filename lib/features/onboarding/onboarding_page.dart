...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  List<_OnboardingStep> get _employeeSteps => const [
        ...
        _OnboardingStep(
          ...
          points: [
            ...
            'График — смены с переключением недели и месяца',
            'Неделя показывает подробности, месяц — обзор',
            'Шестерёнка сверху — настройки и это обучение',
          ],
        ...
        _OnboardingStep(
          ...
          description:
              'На главной видна ближайшая смена. В разделе «График» выберите день, чтобы увидеть время и статус конкретной смены.',
          points: [
        ...
        _OnboardingStep(
          ...
          title: 'Всё готово',
          description:
              'Начните с главной страницы. Если что-то забудется, нажмите шестерёнку → «Обучение сотрудника».',
          points: [
  ...
  List<_OnboardingStep> get _managerSteps => const [
        ...
        _OnboardingStep(
          ...
          description:
              'На телефоне рабочие разделы находятся снизу, настройки — под шестерёнкой сверху. На компьютере меню расположено слева.',
          points: [
            'Главная — ближайшие смены и быстрый обзор',
            'График — неделя и месяц в одном разделе',
            'Табель — итог месяца, Excel, импорт и отправка',
            'Сотрудники — список и добавление людей',
          ],
          visual: _OnboardingVisual.navigation,
        ),
        _OnboardingStep(
          ...
          description:
              'В разделе «График» нажмите «Сегодня» или выберите дату. Большой список удобно сократить фильтрами.',
          points: [
        ...
        _OnboardingStep(
          ...
          description:
              'В разделе «График» нажмите «Сегодня» → «Отметить сотрудников», затем отмечайте людей по одному или сразу целой группой.',
          points: [
        ...
        _OnboardingStep(
          ...
          description:
              'Откройте «График» → «Сегодня» → «Отметить сотрудников» и пройдите рабочий цикл. Повторное обучение находится в настройках.',
          points: [
...
class _NavigationPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      (Icons.table_view_outlined, 'Табель'),
      (Icons.people_outline, 'Сотрудники'),
    ];
    return Row(
      children: [
