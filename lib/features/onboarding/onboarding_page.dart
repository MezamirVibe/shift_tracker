  ...
  List<_OnboardingStep> get _employeeSteps => const [
        ...
        _OnboardingStep(
          ...
          points: [
            ...
            'Неделя — подробности каждой смены за семь дней',
            'Месяц — быстрый обзор всего календаря',
        ...
        _OnboardingStep(
          ...
          description:
              'На главной видна ближайшая смена. В разделе «Неделя» выберите день, чтобы увидеть время и статус конкретной смены.',
          points: [
  ...
  List<_OnboardingStep> get _managerSteps => const [
        ...
        _OnboardingStep(
          ...
          points: [
            ...
            'Неделя — план, сотрудники и фактические выходы',
            'Месяц — сводные показатели по дням календаря',
        ...
        _OnboardingStep(
          ...
          description:
              'В разделе «Неделя» нажмите «Сегодня» или выберите дату. Большой список удобно сократить фильтрами.',
          points: [
        ...
        _OnboardingStep(
          ...
          description:
              'В разделе «Неделя» нажмите «Сегодня» → «Отметить сотрудников», затем отмечайте людей по одному или сразу целой группой.',
          points: [
        ...
        _OnboardingStep(
          ...
          description:
              'Откройте «Неделя» → «Сегодня» → «Отметить сотрудников» и пройдите рабочий цикл. Повторное обучение находится в настройках.',
          points: [
...
class _NavigationPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      (Icons.calendar_view_week_outlined, 'Неделя'),
      (Icons.calendar_month_outlined, 'Месяц'),
